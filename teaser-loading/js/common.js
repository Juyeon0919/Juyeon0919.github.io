const splashVideo = document.querySelector('._splash');
const mainVideo = document.querySelector('._video');
const loadingSpinner = document.querySelector('._loading');
...
splashVideo.addEventListener('loadstart', handleLoadStart);
mainVideo.addEventListener('loadstart', handleLoadStart);

splashVideo.addEventListener('canplaythrough', handleCanPlayThrough);
